...
import io.github.zhztheplayer.velox4j.test.dataset.TestDataFile;
import io.github.zhztheplayer.velox4j.type.RowType;

/**
 * A TPC-H Parquet SF0.1 dataset downloaded from GitHub repo boostscale/tpc-data. Note, this is a
 ...
 * <pre>
 * 1. cd /tmp
 * 2. wget https://github.com/boostscale/tpc-data/releases/download/v0.1.0/tpch-parquet-sf0.1.tar.gz
...
class DownloadedTpchDataset implements TpchDataset {
  private static final String DOWNLOAD_LINK =
      "https://github.com/boostscale/tpc-data/releases/download/v0.1.0/tpch-parquet-sf0.1.tar.gz";
