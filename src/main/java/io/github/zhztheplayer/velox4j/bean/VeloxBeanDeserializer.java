...
public class VeloxBeanDeserializer {
  private VeloxBeanDeserializer() {
  }

  private static class PolymorphicBeanDeserializer extends JsonDeserializer<Object> {
    public PolymorphicBeanDeserializer() {
    }
    ...
    public JsonDeserializer<?> modifyDeserializer(DeserializationConfig config, BeanDescription beanDesc, JsonDeserializer<?> deserializer) {
      if (VeloxBean.class.isAssignableFrom(beanDesc.getBeanClass())) {
        if (java.lang.reflect.Modifier.isAbstract(beanDesc.getBeanClass().getModifiers())) {
          ...
          return new PolymorphicBeanDeserializer();
        }
      }
      return deserializer;
    }
